...
import ShowDepCompaniesService from './show-dep-comp.service.js';
const show = new ShowDepCompaniesService();


class UpdateDepCompaniesService {
  constructor() {
...
export default UpdateDepCompaniesService;
